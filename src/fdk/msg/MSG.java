...
public class MSG {
	...
	/**
	 * Читает из потока данные MSG файла с исппользованием кодировки по умолчанию.
	 * 
	 ...
	 * @throws WrongMsgEncoding
	 *           при невозможности кодировать исходный текст в заданную кодировку
	 */
	 ...
	 * 
	 * Если номер удаляемого сообщения был не уникален, то по данному номеру стает
	 * доступно последнее сообщение с таким номером.
	 * 
	 * @param num
	 *          номер записи
