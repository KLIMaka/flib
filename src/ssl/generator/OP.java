...
public class OP {
	...
	A_TO_D =					( (short) 0x800C ),
	D_TO_A =					( (short) 0x800D ),
	EXIT =						( (short) 0x800E ),       // exit prog and purge it from process queue
	DETACH =					( (short) 0x800F ),     // detach spawned process from its parent.
	EXIT_PROG =					( (short) 0x8010 ),  // exit program but leave it in process queue
   ...
   // on the stack.
	...
	CHECK_ARG_COUNT =			( (short) 0x8027 ),   // call to do a run-time check of arguments to functions
	LOOKUP_STRING_PROC =		( (short) 0x8028 ), // call to lookup a procedure index given a string
	POP_BASE =					( (short) 0x8029 ),
	POP_TO_BASE =				( (short) 0x802A ),
	PUSH_BASE =					( (short) 0x802B ),
	SET_GLOBAL =				( (short) 0x802C ),
	FETCH_PROC_ADDRESS =		( (short) 0x802D ),
	DUMP =						( (short) 0x802E ),
	IF =						( (short) 0x802F ),
	WHILE =						( (short) 0x8030 ),
	STORE =						( (short) 0x8031 ),
	FETCH =						( (short) 0x8032 ),
	EQUAL =						( (short) 0x8033 ),
	NOT_EQUAL =					( (short) 0x8034 ),
	LESS_EQUAL =				( (short) 0x8035 ),
	GREATER_EQUAL =				( (short) 0x8036 ),
	LESS =						( (short) 0x8037 ),
	GREATER =					( (short) 0x8038 ),
	ADD =						( (short) 0x8039 ),
	SUB =						( (short) 0x803A ),
	MUL =						( (short) 0x803B ),
	DIV =						( (short) 0x803C ),
	...
	STARTCRITICAL =				( (short) 0x804A ),
	ENDCRITICAL =				( (short) 0x804B ),
	
	END_CORE =					( (short) 0x804C ),
	
	
	//////////////////////////////////////////////////////
	OPERATOR = 					( (short) 0x8000 ),
	INT = 						( (short) 0x4000 ),
	FLOAT = 					( (short) 0x2000 ),
	STRING = 					( (short) 0x1000 ),
	
	INTOP = 					( (short) (CONST|INT) ),
	FLOATOP = 					( (short) (CONST|FLOAT) ),
